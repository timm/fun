...
top="<button class=\"button\"><a href=\"/fun/ABOUT\">about</a></button>   <button class=\"button1\"><a href=\"$Git/issues\">discuss</a></button>    <button class=\"button2\"><a href=\"/fun/license\">license</a></button> "
