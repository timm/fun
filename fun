...
top="<button class=\"button button1\"><a href=\"/fun/ABOUT\">about</a></button>   <button class=\"button button2\"><a href=\"$Git/issues\">discuss</a></button>    <button class=\"button button3\"><a href=\"/fun/license\">license</a></button> "
